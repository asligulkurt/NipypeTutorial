...
if __name__ == "__main__":
    ...
    log_filename = "D:/cembe_yedek/Documents/Master/Code/newest_exp2_exp3_exp4/prt_log_files/"+experiment_id+"/"+subject_id+"_log_data/"+folder_name+"/"+session_type+"_log_"+subject_id[-2:]+"_run_"+str(run_id)+"_left_right.txt"
    fixation_log_filename = "D:/cembe_yedek/Documents/Master/Code/newest_exp2_exp3_exp4/prt_log_files/"+experiment_id+"/"+subject_id+"_log_data/"+folder_name+"/"+session_type+"_log_"+subject_id[-2:]+"_run_"+str(run_id)+"_left_right_fixation_log.txt"
